...
/* Version 1 Test Script for testing selection of item in Static Dropdown (bad design => feature 1)
...
(async function example() {
  ...
  try {
	...
	let cssSelector = `body > app-root > ${appVersion} > div > div > div.feature1 > div > div > a:nth-child(2)`;
