...
/* Version 1 Test Script for testing input of mobile number in text input field (bad design => feature 3)
...
(async function example() {
  ...
  try {
	...
	await driver.findElement(By.css(cssSelector)).clear();
	let number4  = "dummyText"		// textual input
	console.log(`Testing with number ${number4} i.e. textual input`);
	await driver.sleep(2000);
	...
	await driver.findElement(By.css(cssSelector)).clear();
	let number5  = -1		// negative input
	console.log(`Testing with negative input ${number5}`);
	await driver.sleep(2000);
	...
	await driver.findElement(By.css(cssSelector)).clear();
	console.log(count);
	if(count==5) console.log("Test Case Passed");
